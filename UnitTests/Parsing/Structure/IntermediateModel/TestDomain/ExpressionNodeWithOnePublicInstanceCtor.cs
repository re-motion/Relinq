...
{
  public class ExpressionNodeWithOnePublicInstanceCtor : IExpressionNode
  {
    static ExpressionNodeWithOnePublicInstanceCtor ()
    {
    }
    ...
    protected ExpressionNodeWithOnePublicInstanceCtor (int parameter)
    {
    }
