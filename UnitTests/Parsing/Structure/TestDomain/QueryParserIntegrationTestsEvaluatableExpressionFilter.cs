...
{
  public class QueryParserIntegrationTestsEvaluatableExpressionFilter : EvaluatableExpressionFilterBase
  {
    public override bool IsEvaluatableMethodCall (MethodCallExpression node)
    {
      if (node.Method == ReflectionUtility.GetMethod (() => NonEvaluated.GetFixedID()))
        return false;
