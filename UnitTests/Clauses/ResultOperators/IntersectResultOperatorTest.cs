...
namespace Remotion.Linq.UnitTests.Clauses.ResultOperators
{
  ...
  public class IntersectResultOperatorTest
  {
    ...
    {
      var resultOperator = new IntersectResultOperator (new ReducibleExtensionExpression (new ReducibleExtensionExpression (_source2)));
    ...
    {
      var resultOperator = new IntersectResultOperator (new RecursiveReducibleExtensionExpression (_source2.Type));
      Assert.That (
