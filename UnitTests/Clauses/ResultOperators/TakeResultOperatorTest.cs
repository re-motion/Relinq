...
namespace Remotion.Linq.UnitTests.Clauses.ResultOperators
{
  ...
  public class TakeResultOperatorTest
  {
    ...
    {
      var resultOperator = new TakeResultOperator (new ReducibleExtensionExpression (new ReducibleExtensionExpression (Expression.Constant (2))));
    ...
    {
      var resultOperator = new TakeResultOperator (new RecursiveReducibleExtensionExpression (typeof (int)));
      Assert.That (
          () => resultOperator.GetConstantCount(),
#if !NET_3_5
