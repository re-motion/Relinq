...
namespace Rubicon.Data.DomainObjects.Linq.UnitTests.ParsingTest.QueryParserIntegrationTest
{
  ...
  public class ThreeFromWhereQueryTest : QueryTestBase<Student>
  {
    ...
    public override void CheckFromLetWhereClauses ()
    {
      ...
      Assert.AreSame (SourceExpressionNavigator.Arguments[0].Arguments[0].Arguments[1].Operand.Expression, fromClause1.Expression);

      WhereClause whereClause = ParsedQuery.QueryBody.FromLetWhereClauses.Skip (1).First() as WhereClause;
