...
namespace Rubicon.Data.Linq.UnitTests.ParsingTest.SelectManyExpressionParserTest
{
  ...
  public class RecursiveSelectManyExpressionParserTest
  {
    ...
    public void ParsesFromExpressions ()
    {
      ...
      Assert.IsInstanceOfType (typeof (LambdaExpression), _fromLetWhereHelper.FromExpressions[2]);
      ...
      LambdaExpression fromExpression2 = (LambdaExpression) _fromLetWhereHelper.FromExpressions[2];
    ...
    public void ParsesFromIdentifiers ()
    {
      ...
      Assert.IsInstanceOfType (typeof (ParameterExpression), _fromLetWhereHelper.FromIdentifiers[2]);
      ...
      Assert.AreEqual ("s3", _fromLetWhereHelper.FromIdentifiers[2].Name);
    }
