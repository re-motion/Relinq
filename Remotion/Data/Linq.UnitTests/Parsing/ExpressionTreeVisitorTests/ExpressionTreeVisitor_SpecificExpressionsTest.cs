...
namespace Remotion.Data.Linq.UnitTests.Parsing.ExpressionTreeVisitorTests
{
  ...
  public class ExpressionTreeVisitor_SpecificExpressionsTest : ExpressionTreeVisitorTestBase
  {
    ...
    public void VisitLambdaExpression_Unchanged ()
    {
      ...
      Expect.Call (VisitorMock.VisitExpressionList (expression.Parameters, "VisitLambdaExpression")).Return (expression.Parameters);
    ...
    public void VisitLambdaExpression_ChangedParameters ()
    {
      ...
      Expect.Call (VisitorMock.VisitExpression (expression.Body)).Return (expression.Body);
      Expect.Call (VisitorMock.VisitExpressionList (expression.Parameters, "VisitLambdaExpression")).Return (newParameters);
      var result = (LambdaExpression) InvokeAndCheckVisitExpression ("VisitLambdaExpression", expression);
      Assert.That (result, Is.Not.SameAs (expression));
      Assert.That (result.NodeType, Is.EqualTo (ExpressionType.Lambda));
    ...
    public void VisitMethodCallExpression_Unchanged ()
    {
      ...
      Expect.Call (VisitorMock.VisitExpressionList (expression.Arguments, "VisitMethodCallExpression")).Return (expression.Arguments);
    ...
    public void VisitMethodCallExpression_ChangedArguments ()
    {
      ...
      Expect.Call (VisitorMock.VisitExpression (expression.Object)).Return (expression.Object);
      Expect.Call (VisitorMock.VisitExpressionList (expression.Arguments, "VisitMethodCallExpression")).Return (newParameters);
      var result = (MethodCallExpression) InvokeAndCheckVisitExpression ("VisitMethodCallExpression", expression);
      Assert.That (result, Is.Not.SameAs (expression));
      Assert.That (result.NodeType, Is.EqualTo (ExpressionType.Call));
    ...
    public void VisitInvocationExpression_Unchanged ()
    {
      ...
      Expect.Call (VisitorMock.VisitExpression (expression.Expression)).Return (expression.Expression);
      Expect.Call (VisitorMock.VisitExpressionList (expression.Arguments, "VisitInvocationExpression")).Return (expression.Arguments);
    ...
    public void VisitInvocationExpression_ChangedArguments ()
    {
      ...
      ReadOnlyCollection<Expression> newParameters = new List<Expression> { Expression.Constant (214578) }.AsReadOnly ();
      Expect.Call (VisitorMock.VisitExpression (expression.Expression)).Return (expression.Expression);
      Expect.Call (VisitorMock.VisitExpressionList (expression.Arguments, "VisitInvocationExpression")).Return (newParameters);
      var result = (InvocationExpression) InvokeAndCheckVisitExpression ("VisitInvocationExpression", expression);
      Assert.That (result, Is.Not.SameAs (expression));
      Assert.That (result.NodeType, Is.EqualTo (ExpressionType.Invoke));
      Assert.That (result.Arguments, Is.EqualTo (newParameters));
    ...
    public void VisitNewExpression_Unchanged ()
    {
      ...
      Expect.Call (VisitorMock.VisitExpressionList (expression.Arguments, "VisitNewExpression")).Return (expression.Arguments);
    ...
    public void VisitNewExpression_ChangedArguments ()
    {
      ...
      Expect.Call (VisitorMock.VisitExpressionList (expression.Arguments, "VisitNewExpression")).Return (newArguments);
      var result = (NewExpression) InvokeAndCheckVisitExpression ("VisitNewExpression", expression);
      Assert.That (result, Is.Not.SameAs (expression));
    ...
    public void VisitNewArrayExpression_Unchanged ()
    {
      ...
      Expect.Call (VisitorMock.VisitExpressionList (expression.Expressions, "VisitNewArrayExpression")).Return (expression.Expressions);
    ...
    public void VisitNewArrayExpression_Init_Changed ()
    {
      ...
      Expect.Call (VisitorMock.VisitExpressionList (expression.Expressions, "VisitNewArrayExpression")).Return (newExpressions);
      var result = (NewArrayExpression) InvokeAndCheckVisitExpression ("VisitNewArrayExpression", expression);
      Assert.That (result, Is.Not.SameAs (expression));
    ...
    public void VisitElementInit_Unchanged ()
    {
      ...
      Expect.Call (VisitorMock.VisitExpressionList (elementInit.Arguments, "VisitElementInit")).Return (elementInit.Arguments);
    ...
    public void VisitElementInit_Changed ()
    {
      ...
      Expect.Call (VisitorMock.VisitExpressionList (elementInit.Arguments, "VisitElementInit")).Return (newArguments);
