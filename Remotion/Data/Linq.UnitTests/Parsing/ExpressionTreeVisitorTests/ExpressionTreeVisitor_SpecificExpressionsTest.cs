...
namespace Remotion.Data.Linq.UnitTests.Parsing.ExpressionTreeVisitorTests
{
  ...
  public class ExpressionTreeVisitor_SpecificExpressionsTest : ExpressionTreeVisitor_SpecificExpressionsTestBase
  {
    ...
    public void VisitUnaryExpression_Unchanges ()
    {
      ...
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", expectedNextVisit)).Return (expectedNextVisit);
    ...
    public void VisitUnaryExpression_UnaryPlus_Changes ()
    {
      ...
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", expectedNextVisit)).Return (newOperand);
    ...
    public void VisitConditionalExpression_Unchanged ()
    {
      ...
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", expression.Test)).Return (expression.Test);
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", expression.IfFalse)).Return (expression.IfFalse);
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", expression.IfTrue)).Return (expression.IfTrue);
    ...
    public void VisitConditionalExpression_ChangedTest ()
    {
      ...
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", expression.Test)).Return (newTest);
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", expression.IfFalse)).Return (expression.IfFalse);
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", expression.IfTrue)).Return (expression.IfTrue);
      var result = (ConditionalExpression) InvokeAndCheckVisitExpression ("VisitConditionalExpression", expression);
      Assert.That (result, Is.Not.SameAs (expression));
    ...
    public void VisitConditionalExpression_ChangedFalse ()
    {
      ...
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", expression.Test)).Return (expression.Test);
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", expression.IfFalse)).Return (newFalse);
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", expression.IfTrue)).Return (expression.IfTrue);
      var result = (ConditionalExpression) InvokeAndCheckVisitExpression ("VisitConditionalExpression", expression);
      Assert.That (result, Is.Not.SameAs (expression));
      Assert.That (result.NodeType, Is.EqualTo (ExpressionType.Conditional));
    ...
    public void VisitConditionalExpression_ChangedTrue ()
    {
      ...
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", expression.Test)).Return (expression.Test);
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", expression.IfFalse)).Return (expression.IfFalse);
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", expression.IfTrue)).Return (newTrue);
      var result = (ConditionalExpression) InvokeAndCheckVisitExpression ("VisitConditionalExpression", expression);
      Assert.That (result, Is.Not.SameAs (expression));
      Assert.That (result.NodeType, Is.EqualTo (ExpressionType.Conditional));
    ...
    public void VisitLambdaExpression_ChangedBody ()
    {
      ...
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", expression.Body)).Return (newBody);
      Expect.Call (InvokeVisitExpressionListMethod (expression.Parameters)).Return (expression.Parameters);
      var result = (LambdaExpression) InvokeAndCheckVisitExpression ("VisitLambdaExpression", expression);
      Assert.That (result, Is.Not.SameAs (expression));
    ...
    public void VisitMethodCallExpression_ChangedObject ()
    {
      ...
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", expression.Object)).Return (newObject);
      Expect.Call (InvokeVisitExpressionListMethod (expression.Arguments)).Return (expression.Arguments);
      var result = (MethodCallExpression) InvokeAndCheckVisitExpression ("VisitMethodCallExpression", expression);
      Assert.That (result, Is.Not.SameAs (expression));
    ...
    {
      var expression = (MemberInitExpression) ExpressionInstanceCreator.GetExpressionInstance (ExpressionType.MemberInit);
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", expression.NewExpression)).Return (Expression.Constant (0));
      Expect.Call (InvokeVisitMethod ("VisitMemberBindingList", expression.Bindings)).Return (expression.Bindings);
      try
      {
    ...
    public void VisitMemberInitExpression_ChangedNewExpression ()
    {
      ...
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", expression.NewExpression)).Return (newNewExpression);
      Expect.Call (InvokeVisitMethod ("VisitMemberBindingList", expression.Bindings)).Return (expression.Bindings);
      var result = (MemberInitExpression) InvokeAndCheckVisitExpression ("VisitMemberInitExpression", expression);
      Assert.That (result, Is.Not.SameAs (expression));
    ...
    {
      MemberAssignment memberAssignment = ExpressionInstanceCreator.CreateMemberAssignment();
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", memberAssignment.Expression)).Return (memberAssignment.Expression);
    ...
    public void VisitMemberAssignment_Changed ()
    {
      ...
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", memberAssignment.Expression)).Return (newMemberAssignment.Expression);
    ...
    public void VisitExpressionList_Unchanged ()
    {
      ...
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", expr1)).Return (expr1);
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", expr2)).Return (expr2);
    ...
    public void VisitExpressionList_Changed ()
    {
      ...
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", expr1)).Return (expr1);
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", expr2)).Return (newExpression);
      Expect.Call (InvokeVisitMethod<Expression> ("VisitExpression", expr3)).Return (expr3);
      ReadOnlyCollection<Expression> result = InvokeAndCheckVisitExpressionList (expressions);
    ...
    public void VisitUnknownExpression ()
    {
      ...
      Expect.Call (InvokeVisitMethod<Expression> ("VisitUnknownExpression", expressionNode)).CallOriginalMethod (OriginalCallOptions.CreateExpectation);
      MockRepository.ReplayAll();
