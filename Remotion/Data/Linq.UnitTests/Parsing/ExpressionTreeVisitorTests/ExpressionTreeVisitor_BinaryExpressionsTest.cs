...
namespace Remotion.Data.Linq.UnitTests.Parsing.ExpressionTreeVisitorTests
{
  ...
  public class ExpressionTreeVisitor_BinaryExpressionsTest : ExpressionTreeVisitor_SpecificExpressionsTestBase
  {
    ...
    public void VisitBinaryExpression_Unchanged ()
    {
      ...
      Expect.Call (InvokeVisitExpressionMethod (expression.Left)).Return (expression.Left);
      Expect.Call (InvokeVisitExpressionMethod (expression.Right)).Return (expression.Right);
      Expect.Call (InvokeVisitExpressionMethod (expression.Conversion)).Return (expression.Conversion);
    ...
    public void VisitBinaryExpression_LeftChanged ()
    {
      ...
      Expect.Call (InvokeVisitExpressionMethod (expression.Left)).Return (newOperand);
      Expect.Call (InvokeVisitExpressionMethod (expression.Right)).Return (expression.Right);
      Expect.Call (InvokeVisitExpressionMethod (expression.Conversion)).Return (expression.Conversion);
    ...
    public void VisitBinaryExpression_RightChanged ()
    {
      ...
      Expression newOperand = Expression.Constant (1);
      Expect.Call (InvokeVisitExpressionMethod (expression.Left)).Return (expression.Left);
      Expect.Call (InvokeVisitExpressionMethod (expression.Right)).Return (newOperand);
      Expect.Call (InvokeVisitExpressionMethod (expression.Conversion)).Return (expression.Conversion);
    ...
    public void VisitBinaryExpression_ConversionExpression_Changed ()
    {
      ...
      Expect.Call (InvokeVisitExpressionMethod (expression.Left)).Return (expression.Left);
      Expect.Call (InvokeVisitExpressionMethod (expression.Right)).Return (expression.Right);
      Expect.Call (InvokeVisitExpressionMethod (expression.Conversion)).Return (newConversion);
