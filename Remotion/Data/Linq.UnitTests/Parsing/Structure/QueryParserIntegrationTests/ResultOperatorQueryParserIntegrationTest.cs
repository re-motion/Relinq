...
namespace Remotion.Data.Linq.UnitTests.Parsing.Structure.QueryParserIntegrationTests
{
  ...
  public class ResultOperatorQueryParserIntegrationTest : QueryParserIntegrationTestBase
  {
    ...
    public void All ()
    {
      ...
      CheckResolvedExpression<Cook, bool> (((AllResultOperator) queryModel.ResultOperators[0]).Predicate, queryModel.MainFromClause, s => s.IsExchangeStudent);
    }
    ...
    public void Any_WithPredicate ()
    {
      ...
      CheckResolvedExpression<Cook, bool> (((WhereClause) queryModel.BodyClauses[0]).Predicate, queryModel.MainFromClause, s => s.IsExchangeStudent);
