...
namespace Remotion.Data.Linq.UnitTests.Linq.Core.IntegrationTests.LinqSamples101.TestDomain
{
  /// <summary>
  ...
  public static class QuerySource
  {
    ...
    {
      get { return new TestQueryable<Customer> ("Customers"); }
    }

    public static IQueryable<Employee> Employees
    {
      get { return new TestQueryable<Employee> ("Employees"); }
    }

    public static IQueryable<Order> Orders
    {
      get { return new TestQueryable<Order> ("Orders"); }
    }
  }
}
