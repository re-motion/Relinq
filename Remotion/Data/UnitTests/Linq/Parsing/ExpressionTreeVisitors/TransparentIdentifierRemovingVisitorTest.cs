...
namespace Remotion.Data.UnitTests.Linq.Parsing.ExpressionTreeVisitors
{
  ...
  public class TransparentIdentifierRemovingVisitorTest
  {
    ...
    public void MemberExpression_WithMemberInitExpression_ReplacedByAssignedExpression ()
    {
      ...
      var result = TransparentIdentifierRemovingVisitor.ReplaceTransparentIdentifiers (memberExpression);
    ...
    public void TransparentIdentifier_WithinAnotherExpression ()
    {
      ...
      var result = TransparentIdentifierRemovingVisitor.ReplaceTransparentIdentifiers (Expression.Lambda (memberExpression));
    ...
    public void TransparentIdentifier_WithinAnotherMemberExpression ()
    {
      ...
      var result = TransparentIdentifierRemovingVisitor.ReplaceTransparentIdentifiers (outerMemberExpression);
    ...
    public void IntegrationTest_WithSimpleExpressions ()
    {
      ...
      var result2 = TransparentIdentifierRemovingVisitor.ReplaceTransparentIdentifiers (expression2);
    ...
    public void IntegrationTest_WithExpressionNodes ()
    {
      ...
      var selectNode = (SelectExpressionNode) new ExpressionTreeParser (nodeTypeRegistry).Parse (query.Expression, null);
