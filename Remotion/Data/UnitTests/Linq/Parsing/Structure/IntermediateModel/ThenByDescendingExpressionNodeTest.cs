...
namespace Remotion.Data.UnitTests.Linq.Parsing.Structure.IntermediateModel
{
  ...
  public class ThenByDescendingExpressionNodeTest : ExpressionNodeTestBase
  {
    ...
    public void Resolve_PassesExpressionToSource ()
    {
      ...
      var node = new ThenByDescendingExpressionNode ("TODO", sourceMock, selector);
    ...
    public void CreateParameterForOutput ()
    {
      ...
      var node = new ThenByDescendingExpressionNode ("TODO", source, ExpressionHelper.CreateLambdaExpression<int, int> (i => i));
    ...
    public void GetResolvedSelector ()
    {
      ...
      var node = new ThenByDescendingExpressionNode ("TODO", SourceStub, selector);
