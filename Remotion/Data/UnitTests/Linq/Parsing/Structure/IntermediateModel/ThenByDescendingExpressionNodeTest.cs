...
namespace Remotion.Data.UnitTests.Linq.Parsing.Structure.IntermediateModel
{
  ...
  public class ThenByDescendingExpressionNodeTest : ExpressionNodeTestBase
  {
    ...
    public void CreateParameterForOutput ()
    {
      ...
      var node = new ThenByDescendingExpressionNode (CreateParseInfo (source, "y"), ExpressionHelper.CreateLambdaExpression<int, int> (i => i));
    ...
    public void GetResolvedSelector_Cached ()
    {
      ...
      node.GetResolvedKeySelector (QuerySourceClauseMapping);
      node.GetResolvedKeySelector (QuerySourceClauseMapping);
