...
namespace Remotion.Data.UnitTests.Linq.Parsing.Structure.IntermediateModel
{
  ...
  public class SingleOrDefaultExpressionNodeTest : ExpressionNodeTestBase
  {
    ...
    {
      var node = new SingleOrDefaultExpressionNode ("x", SourceStub, null);
    ...
    public void GetResolvedPredicate ()
    {
      ...
      var node = new SingleOrDefaultExpressionNode ("x", SourceStub, predicate);
    ...
    public void GetResolvedPredicate_Null ()
    {
      ...
      var node = new SingleOrDefaultExpressionNode ("x", sourceMock, null);
      var result = node.GetResolvedOptionalPredicate ();
    ...
    public void GetResolvedPredicate_Cached ()
    {
      ...
      var predicate = ExpressionHelper.CreateLambdaExpression<int, bool> (i => i > 5);
      var node = new SingleOrDefaultExpressionNode ("x", sourceMock, predicate);
    ...
    public void CreateClause_WithoutOptionalPredicate_PreviousClauseIsNoSelect ()
    {
      ...
      var node = new SingleOrDefaultExpressionNode ("x", source, null);
    ...
    {
      var node = new SingleOrDefaultExpressionNode ("x", SourceStub, ExpressionHelper.CreateLambdaExpression<int, bool> (i => i > 5));
