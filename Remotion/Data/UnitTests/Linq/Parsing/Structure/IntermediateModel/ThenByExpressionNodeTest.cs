...
namespace Remotion.Data.UnitTests.Linq.Parsing.Structure.IntermediateModel
{
  ...
  public class ThenByExpressionNodeTest : ExpressionNodeTestBase
  {
    ...
    public void Resolve_PassesExpressionToSource ()
    {
      ...
      var node = new ThenByExpressionNode ("TODO", sourceMock, selector);
    ...
    public void CreateParameterForOutput ()
    {
      ...
      var node = new ThenByExpressionNode ("TODO", source, ExpressionHelper.CreateLambdaExpression<int, int> (i => i));
    ...
    public void GetResolvedSelector ()
    {
      ...
      var node = new ThenByExpressionNode ("TODO", SourceStub, selector);
    ...
    public void CreateClause ()
    {
      ...
      Assert.That (clause.OrderingList.Last ().OrderingDirection, Is.EqualTo (OrderingDirection.Asc));
