...
namespace Remotion.Data.UnitTests.Linq.Parsing.Structure.IntermediateModel
{
  ...
  public class OrderByDescendingExpressionNodeTest : ExpressionNodeTestBase
  {
    ...
    public void Resolve_PassesExpressionToSource ()
    {
      ...
      var node = new OrderByDescendingExpressionNode ("TODO", sourceMock, selector);
    ...
    public void CreateParameterForOutput ()
    {
      ...
      var node = new OrderByDescendingExpressionNode ("TODO", source, ExpressionHelper.CreateLambdaExpression<int, int> (i => i));
    ...
    public void GetResolvedSelector ()
    {
      ...
      var node = new OrderByDescendingExpressionNode ("TODO", SourceStub, selector);
