...
namespace Remotion.Data.UnitTests.Linq.Parsing.Structure.IntermediateModel
{
  ...
  public class LastExpressionNodeTest : ExpressionNodeTestBase
  {
    ...
    public void GetResolvedPredicate ()
    {
      ...
      var node = new LastExpressionNode (SourceStub, predicate);
    ...
    public void GetResolvedPredicate_Cached ()
    {
      ...
      var predicate = ExpressionHelper.CreateLambdaExpression<int, bool> (i => i > 5);
      var node = new LastExpressionNode (sourceMock, predicate);
    ...
    {
      var node = new LastExpressionNode (SourceStub, ExpressionHelper.CreateLambdaExpression<int, bool> (i => i > 5));
