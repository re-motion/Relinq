...
{
  [TestFixture]
  public class ReverseResultOperatorTest
  {
    private ReverseResultOperator _resultOperator;
    ...
    public void ExecuteInMemory ()
    {
      ...
      Assert.That (result.GetCurrentSequenceInfo<int>().Sequence.ToArray(), Is.EquivalentTo (new[] { 3, 2, 1 }));
    }
