...
namespace Remotion.Data.Linq
{
  ...
  public abstract class QueryableBase<T> : IOrderedQueryable<T>
  {
    ...
    protected QueryableBase (IQueryExecutor executor, IQueryParser queryParser)
    {
      ArgumentUtility.CheckNotNull ("executor", executor);
      ArgumentUtility.CheckNotNull ("queryParser", queryParser);

      _queryProvider = new DefaultQueryProvider (GetType().GetGenericTypeDefinition(), executor, queryParser);
