...
namespace Remotion.Data.Linq.Clauses
{
  ...
  /// </summary>
  public abstract class FromClauseBase : IClause, IQuerySourceWithItemType
  {
    ...
    /// </summary>
    /// <note type="warning">
    /// Changing the <see cref="ItemType"/> of a <see cref="IQuerySourceWithItemType"/> can make all <see cref="QuerySourceReferenceExpression"/> objects that
    /// point to that <see cref="IQuerySourceWithItemType"/> invalid, so the property setter should be used with care.
    /// </note>
