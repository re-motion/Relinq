...
namespace Remotion.Data.Linq.Clauses
{
  public class JoinClause : IClause
  {
    ...
    /// </summary>
    /// <param name="fromClause">The from clause this <see cref="JoinClause"/> belongs to.</param>
    ...
    public JoinClause (FromClauseBase fromClause, string itemName, Type itemType, Expression inExpression, Expression onExpression, Expression equalityExpression)
    {
    ...
    public JoinClause Clone (CloneContext cloneContext)
    {
      ...
      var result = new JoinClause (newFromClause, ItemName, ItemType, newInExpression, newOnExpression, newEqualityExpression);
