...
namespace Remotion.Data.Linq.Parsing.Structure.IntermediateModel
{
  ...
  /// </summary>
  public class SingleOrDefaultExpressionNode : ResultModificationExpressionNodeBase
  {
    ...
    public SingleOrDefaultExpressionNode (string associatedIdentifier, IExpressionNode source, LambdaExpression optionalPredicate)
        : base (
