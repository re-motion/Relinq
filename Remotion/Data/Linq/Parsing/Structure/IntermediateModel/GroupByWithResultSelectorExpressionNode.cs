...
{
  public class GroupByWithResultSelectorExpressionNode : ResultOperatorExpressionNodeBase, IQuerySourceExpressionNode
  {
    ...
    public GroupByWithResultSelectorExpressionNode (MethodCallExpressionParseInfo parseInfo, LambdaExpression keySelector, LambdaExpression elementSelector, LambdaExpression resultSelector)
        : base (parseInfo, null, null)
    {
      ...
      OptionalElementSelector = elementSelector;
