...
namespace Remotion.Linq.Parsing.ExpressionTreeVisitors.Transformation.PredefinedTransformations
{
  ...
  /// <remarks>
  /// <para>
  /// The <see cref="DictionaryEntryNewExpressionTransformer"/> tries to mimic the expressions created by the C# compiler when
  ...
  {
    public DictionaryEntryNewExpressionTransformer (Version frameworkVersion)
