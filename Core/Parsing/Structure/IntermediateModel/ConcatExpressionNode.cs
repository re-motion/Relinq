...
namespace Remotion.Linq.Parsing.Structure.IntermediateModel
{
  ...
  /// <see cref="Queryable.Concat{TSource}(System.Linq.IQueryable{TSource},System.Collections.Generic.IEnumerable{TSource})"/>.
  ...
  public class ConcatExpressionNode : ResultOperatorExpressionNodeBase, IQuerySourceExpressionNode
  {
    public static readonly MethodInfo[] SupportedMethods = new[]
                                                           {
                                                               GetSupportedMethod (() => Queryable.Concat<object> (null, null)),
                                                               GetSupportedMethod (() => Enumerable.Concat<object> (null, null))
                                                           };
