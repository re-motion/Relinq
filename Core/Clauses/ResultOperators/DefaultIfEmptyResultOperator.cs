...
namespace Remotion.Linq.Clauses.ResultOperators
{
  ...
  public sealed class DefaultIfEmptyResultOperator : SequenceTypePreservingResultOperatorBase
  {
    ...
    /// <summary>
    /// Gets the constant <see cref="object"/> value of the <see cref="OptionalDefaultValue"/> property, assuming it can be reduced to a <see cref="ConstantExpression"/>.
    /// If it is not, an <see cref="InvalidOperationException"/> is thrown. If it is <see langword="null" />, <see langword="null" /> is returned.
    /// </summary>
