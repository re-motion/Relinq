...
#get-ChildItem -path $rootPath\build -include '*.xml' -recurse | replace-licenseHeader 'licenseHeader.xml.txt' 'licenseHeader_old.xml.txt'
#get-ChildItem -path $rootPath\build -include '*.build' -recurse | replace-licenseHeader 'licenseHeader.xml.txt' 'licenseHeader_old.xml.txt'
...
#get-ChildItem -path $rootPath\SecurityManager -include '*.js'   -recurse | replace-licenseHeader 'licenseHeaderRestrict.cs.txt' 'licenseHeaderRestrict_old.cs.txt'
...
#get-ChildItem -path $rootPath\DMS -include '*.js'   -recurse | replace-licenseHeader 'licenseHeaderRevision.cs.txt' 'licenseHeaderRevision_old.cs.txt'
#get-ChildItem -path $rootPath\DMS -include '*.aspx' -recurse | replace-licenseHeader 'licenseHeaderRevision.asx.txt' 'licenseHeaderRevision_old.asx.txt'
#get-ChildItem -path $rootPath\DMS -include '*.ascx' -recurse | replace-licenseHeader 'licenseHeaderRevision.asx.txt' 'licenseHeaderRevision_old.asx.txt'
#get-ChildItem -path $rootPath\DMS -include '*.asax' -recurse | replace-licenseHeader 'licenseHeaderRevision.asx.txt' 'licenseHeaderRevision_old.asx.txt'
#get-ChildItem -path $rootPath\DMS -include '*.master' -recurse | replace-licenseHeader 'licenseHeaderRevision.asx.txt' 'licenseHeaderRevision_old.asx.txt'
